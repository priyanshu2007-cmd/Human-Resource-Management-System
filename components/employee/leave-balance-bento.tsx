      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {cards.map((c) => {
          ...
          return (
            <div
              key={c.code}
              className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm dark:shadow-none hover:border-slate-300 dark:hover:border-slate-700 transition-all group relative overflow-hidden"
            >
              {/* Header inside card */}
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-body-sm font-bold text-slate-900 dark:text-slate-100 leading-tight">
                      {c.type}
                    </h3>
                ...
                <div className="text-right">
                  <span className="text-xl font-extrabold font-mono text-slate-900 dark:text-slate-50 block leading-tight">
                    {c.remaining}
                  </span>
              ...
              <p className="text-[11px] text-slate-400 dark:text-slate-500 mt-2.5 pt-2 border-t border-slate-100 dark:border-slate-800/80 truncate">
                {c.description}
              </p>
            </div>
          );
