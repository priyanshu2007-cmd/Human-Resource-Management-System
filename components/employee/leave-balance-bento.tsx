      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {cards.map((c) => {
          ...
          return (
            <div
              key={c.code}
              className="bg-white dark:bg-slate-900 border border-neutral-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm dark:shadow-none hover:border-neutral-300 dark:hover:border-slate-700 transition-all group relative overflow-hidden"
            >
              {/* Header inside card */}
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-body-sm font-bold text-neutral-900 dark:text-slate-100 leading-tight">
                      {c.type}
                    </h3>
                ...
                <div className="text-right">
                  <span className="text-xl font-extrabold font-mono text-neutral-900 dark:text-slate-50 block leading-tight">
                    {c.remaining}
                  </span>
              ...
              <div className="space-y-1.5 pt-2">
                ...
                <div className="flex justify-between text-[11px] text-neutral-500 dark:text-slate-400 font-mono">
                  <span>Used: {c.consumed}d ({percentUsed}%)</span>
                  <span>Total: {c.total}d</span>
                </div>
              </div>

              <p className="text-[11px] text-neutral-400 dark:text-slate-500 mt-2.5 pt-2 border-t border-neutral-100 dark:border-slate-800/80 truncate">
                {c.description}
              </p>
            </div>
          );
