      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 flex flex-col justify-between gap-4">
          ...
          <Link
            ...
            className="flex-1 bg-white dark:bg-slate-900 border border-neutral-200 dark:border-slate-800 rounded-3xl p-5 shadow-sm dark:shadow-none hover:border-indigo-500/50 hover:shadow-md transition-all group relative overflow-hidden flex items-center justify-between"
          >
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <h3 className="text-body-md font-bold text-neutral-900 dark:text-slate-100 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                  My Employee Card
                </h3>
            ...
            <span className="material-symbols-outlined text-neutral-300 dark:text-slate-700 group-hover:text-indigo-500 group-hover:tranneutral-x-0.5 transition-all">
              chevron_right
            </span>
          </Link>
          ...
          <Link
            ...
            className="flex-1 bg-white dark:bg-slate-900 border border-neutral-200 dark:border-slate-800 rounded-3xl p-5 shadow-sm dark:shadow-none hover:border-emerald-500/50 hover:shadow-md transition-all group relative overflow-hidden flex items-center justify-between"
          >
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <h3 className="text-body-md font-bold text-neutral-900 dark:text-slate-100 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                  Monthly Payslips
                </h3>
                <p className="text-xs text-neutral-500 dark:text-slate-400">
            ...
            <span className="material-symbols-outlined text-neutral-300 dark:text-slate-700 group-hover:text-emerald-500 group-hover:tranneutral-x-0.5 transition-all">
              chevron_right
            </span>
          </Link>
          ...
          <Link
            ...
            className="flex-1 bg-white dark:bg-slate-900 border border-neutral-200 dark:border-slate-800 rounded-3xl p-5 shadow-sm dark:shadow-none hover:border-amber-500/50 hover:shadow-md transition-all group relative overflow-hidden flex items-center justify-between"
          >
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <h3 className="text-body-md font-bold text-neutral-900 dark:text-slate-100 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">
                  Attendance History
                </h3>
                <p className="text-xs text-neutral-500 dark:text-slate-400">
            ...
            <span className="material-symbols-outlined text-neutral-300 dark:text-slate-700 group-hover:text-amber-500 group-hover:tranneutral-x-0.5 transition-all">
              chevron_right
            </span>
          </Link>
        </div>
